...
}typed.push(a.keyCode);if(typed.toString()==wat.toString()){zomthng();}});addEvent($("#options-toggler"),"click",function(a){if(hasClass($("#options"),"invisible")){removeClass($("#options"),"invisible");
}else{addClass($("#options"),"invisible");}if(event.preventDefault){event.preventDefault();}else{event.returnValue=false;}});